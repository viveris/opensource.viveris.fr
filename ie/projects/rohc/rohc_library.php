...
Librairie ROHC<br>compression d'ent&ecirc;tes r&eacute;seau IP
</h1>

<h2>Pr&eacute;sentation</h2>
<p>La librairie <acronym title="RObust Header Compression">ROHC</acronym> est
   ...
   algorithmes <acronym title="RObust Header Compression">ROHC</acronym>.</p>
<p>Le protocole <acronym title="RObust Header Compression">ROHC</acronym> est
   une m&eacute;thode de compression sans perte tr&egrave;s efficace lorsqu'elle
   est appliqu&eacute;e aux flux <acronym title="Voice over IP">VoIP</acronym>
   utilisant le protocole <acronym title="Real-time Transport Protocol">RTP</acronym>.
...
<p>La librairie ROHC est destin&eacute;e aux d&eacute;veloppeurs qui souhaitent
   ...
   tourner vers l'<a href="./?page=rohc-iprohc&lang=<?php echo $_GET['lang']; ?>">application
...
<p>La compression/d&eacute;compression <acronym title="RObust Header Compression">ROHC</acronym>
